...
- **Schématiser l’idée (graphe + storyboard + hero)** : section dédiée dans le SKILL ; template [Templates/pilot-outline.md](../Templates/pilot-outline.md).
- **Phase 2 diagrammes `remotion-lib`** : [`remotion-lib-phase2-diagrams.md`](../../../packages/skills/thp-video-generation/references/remotion-lib-phase2-diagrams.md).
